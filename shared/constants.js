...
const MOTION_PRESETS = {
  ...
  ORBIT_DRIFT: { id: 'orbit_drift', name: 'Cinematic Orbit Drift', category: 'Cinematic', startScale: 1.08, endScale: 1.18, startPos: [0.45, 0.52], endPos: [0.55, 0.48], icon: '💫' },
  DIAGONAL_FLOAT: { id: 'diagonal_float', name: 'Diagonal Float', category: 'Smooth', startScale: 1.05, endScale: 1.20, startPos: [0.4, 0.6], endPos: [0.6, 0.4], icon: '↗' },
  DRAMATIC_ZOOM: { id: 'dramatic_zoom', name: 'Dramatic Impact Zoom', category: 'Dynamic', startScale: 1.0, endScale: 1.38, startPos: [0.5, 0.5], endPos: [0.5, 0.5], icon: '⚡' },
...
const TRANSITIONS = {
  ...
  ZOOM_OUT: { id: 'zoomout', name: 'Zoom Out Transition', category: 'Smooth', defaultDuration: 0.5, ffmpegName: 'zoomin', icon: '🔍' },
  SMOOTH_LEFT: { id: 'smoothleft', name: 'Smooth Slide Left', category: 'Smooth', defaultDuration: 0.4, ffmpegName: 'smoothleft', icon: '⇠' },
  SMOOTH_RIGHT: { id: 'smoothright', name: 'Smooth Slide Right', category: 'Smooth', defaultDuration: 0.4, ffmpegName: 'smoothright', icon: '⇢' },
  // Dynamic & Directional
  ...
  WIPE_UP: { id: 'wipeup', name: 'Wipe Up', category: 'Dynamic', defaultDuration: 0.4, ffmpegName: 'wipeup', icon: '▲' },
  WIPE_DOWN: { id: 'wipedown', name: 'Wipe Down', category: 'Dynamic', defaultDuration: 0.4, ffmpegName: 'wipedown', icon: '▼' },
  // Cinematic
  ...
  RADIAL: { id: 'radial', name: 'Radial Clock Wipe', category: 'Cinematic', defaultDuration: 0.5, ffmpegName: 'radial', icon: '⏱' },
  CIRCLE_OPEN: { id: 'circleopen', name: 'Iris Circle Open', category: 'Cinematic', defaultDuration: 0.5, ffmpegName: 'circleopen', icon: '◯' },
  CIRCLE_CLOSE: { id: 'circleclose', name: 'Iris Circle Close', category: 'Cinematic', defaultDuration: 0.5, ffmpegName: 'circleclose', icon: '⬤' },
  // Modern FX
  PIXELIZE: { id: 'pixelize', name: 'Digital Pixelize', category: 'Stylize', defaultDuration: 0.4, ffmpegName: 'pixelize', icon: '▦' },
